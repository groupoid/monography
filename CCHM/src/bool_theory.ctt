...
falseNeqTrue : neg (Path bool false true) =
  \(h : Path bool false true) -> subst bool (boolRec U bool empty) false true h false

trueNeqFalse : neg (Path bool true false) =
  \(h : Path bool true false) -> subst bool (boolRec U empty bool) true false h true
...
setbool' : isSet bool = hedberg bool boolDec
...
lem3 : isProp (Path bool true true) =
...
lem6 : isProp (Path bool false false) =
...
negBoolK : (b : bool) -> Path bool (negation (negation b)) b = split
  false -> <i> false
  true  -> <i> true

-- negBool is hence and equivalence:
negBoolEquiv : equiv bool bool =
  (negation,isoToEquiv bool bool negation negation negBoolK negBoolK)
...
negF2 : F2 -> F2 = subst U (\(X : U) -> (X -> X)) bool F2 boolEqF2 negation
...
F2EqBoolComp : Path U F2 bool =
  composition U F2 bool bool F2EqBool negBoolEq

test2 : bool = trans F2 bool F2EqBoolComp oneF2

negNegEq : Path U bool bool =
  composition U bool bool bool negBoolEq negBoolEq
...
isEquivNegBool : isEquiv bool bool negation =
 isoToEquiv bool bool negation negation negBoolK negBoolK

eqBool : Path U bool bool =
 trans (equiv bool bool) (Path U bool bool)
       (<i> corrUniv bool bool @ -i) (negation,isEquivNegBool)
