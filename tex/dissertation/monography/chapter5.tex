...
\tag{$W$-elimination}
\dfrac
{\splitfrac{w: W \vdash C(w) : Type,\\ x:A,\ u:B(x) \rightarrow W}{v:\Pi (y:B(x)) \rightarrow C(u(y)) \vdash c(x,u,v):C(sup(x,u))}}
...
\dfrac
{\splitfrac{w: W \vdash C(w) : Type,\ x:A,\ u:B(x) \rightarrow W}{v:\Pi (y:B(x)) \rightarrow C(u(y)) \vdash c(x,u,v):C(sup(x,u))}}
{\splitfrac{x:A,\ u:B(x) \rightarrow W \vdash wrec(sup(x,u),c)\ =}{c(x,u,\lambda (y:B(x)) \rightarrow wrec(u(y),c)):C(sup(x,u))}}
\end{equation}
