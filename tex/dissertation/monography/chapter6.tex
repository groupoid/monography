...
MLTT-73 розкладається у спектр $\Pi$, $\Sigma$, та $=$ типів. У цьому розділі ми побудуємо
мінімальну кубічну систему необхідну для вбудовування MLTT-73 у саму себе.
